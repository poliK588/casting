...
export default function Icon({ name, size = 16, color = 'currentColor', className = '' }) {
  ...
  const strokePaths = ['grid','folder','search2','calendar','document','bell','user','users','settings','chart','plus','close','chevDown','chevRight','search','menu','eye','star','map','shield','ruler','car','sparkles'];
