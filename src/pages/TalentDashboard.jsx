  ...
  if (isLoading) {
    return (
      <div className="flex-1 overflow-hidden flex flex-col items-center justify-center">
        <div className="animate-spin w-8 h-8 rounded-full border-[3px] border-white border-t-transparent"></div>
      </div>
    );
  }
    ...
    <div className="flex-1 overflow-hidden flex flex-col">
      <div className="scroll-area flex-1 overflow-y-auto px-6 py-5 flex flex-col gap-5">
        ...
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-xl font-extrabold text-white tracking-tight">My Dashboard</h1>
        ...
        <div className="grid grid-cols-5 gap-3.5">
          ...
          <div className="kpi-card lift glass-panel !rounded-[14px] p-4 pb-[18px] flex flex-col gap-2.5 relative overflow-hidden">
            ...
            <div>
              <div className="text-[28px] font-extrabold leading-[1] tracking-tight text-white">0</div>
              <div className="text-[11px] font-semibold text-slate-400 uppercase tracking-widest mt-1">Active Submissions</div>
            </div>
            <div className="h-1.5 bg-white/10 rounded-full overflow-hidden mt-auto"><div className="h-full rounded-full bg-gradient-to-r from-indigo-500 to-purple-500" style={{ width: '0%' }} /></div>
          </div>
          ...
          <div className="kpi-card lift glass-panel !rounded-[14px] p-4 pb-[18px] flex flex-col gap-2.5 relative overflow-hidden">
            ...
            <div>
              <div className="text-[28px] font-extrabold leading-[1] tracking-tight text-emerald-400">0</div>
              <div className="text-[11px] font-semibold text-slate-400 uppercase tracking-widest mt-1">New Invitations</div>
            </div>
            <div className="h-1.5 bg-white/10 rounded-full overflow-hidden mt-auto"><div className="h-full rounded-full bg-gradient-to-r from-emerald-500 to-emerald-400" style={{ width: '0%' }} /></div>
          </div>
          ...
          <div className="kpi-card lift glass-panel !rounded-[14px] p-4 pb-[18px] flex flex-col gap-2.5 relative overflow-hidden">
            ...
            <div>
              <div className="text-[28px] font-extrabold leading-[1] tracking-tight text-purple-400">0</div>
              <div className="text-[11px] font-semibold text-slate-400 uppercase tracking-widest mt-1">Days Available</div>
            </div>
            <div className="h-1.5 bg-white/10 rounded-full overflow-hidden mt-auto"><div className="h-full rounded-full bg-gradient-to-r from-purple-500 to-purple-400" style={{ width: '0%' }} /></div>
          </div>
          ...
          <div className="kpi-card lift glass-panel !rounded-[14px] p-4 pb-[18px] flex flex-col gap-2.5 relative overflow-hidden">
            ...
            <div>
              <div className="text-[28px] font-extrabold leading-[1] tracking-tight text-amber-400">0</div>
              <div className="text-[11px] font-semibold text-slate-400 uppercase tracking-widest mt-1">Unread Messages</div>
            </div>
          ...
          <div className="kpi-card lift glass-panel !rounded-[14px] p-4 pb-[18px] flex flex-col gap-2.5 relative overflow-hidden">
            ...
            <div>
              <div className="text-[28px] font-extrabold leading-[1] tracking-tight text-indigo-400">{profile?.rating || '—'}</div>
              <div className="text-[11px] font-semibold text-slate-400 uppercase tracking-widest mt-1">Audition Score</div>
            </div>
